...
function OpenQuestion({ onPass }) {
  ...
  return (
    <div className="mt-3 rounded-2xl border-2 border-demo-gold/40 bg-demo-gold/5 overflow-hidden animate-fade-in">
...
export default function Quiz() {
  ...
  return (
    <div className="flex flex-col h-screen bg-demo-bg overflow-hidden" dir="rtl">
